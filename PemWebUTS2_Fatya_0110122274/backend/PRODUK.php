...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($id && $nama && $stok && $harga && $merk_id) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update produk set id = '$id',nama='$nama_',stok='$stok',harga='$harga',merk_id='$merk_id' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into produk(id,nama,stok,harga,merk_id) values ('$id','$nama','$stok','$harga','$merk_id')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row"><?php echo $merk_id ?></td>
                                <td scope="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="merk_id" class="col-sm-2 col-form-label">Merk ID</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="merk_id" name="merk_id" value="<?php echo $merk_id ?>">
                        </div>
                    </div>
                    <div class="col-12">
