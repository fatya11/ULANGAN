...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($id && $tanggal && $produk_id && $quantity) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update pesanan set id = '$id',tanggal='$tanggal',produk_id='$produk_id',quantity='$quantity' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into pesanan(id,tanggal,produk_id,quantity) values ('$id','$tanggal','$produk_id','$quantity')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Swiftiee Shop Admin</a>
            <!-- Sidebar Toggle-->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row"><?php echo $produk_id ?></td>
                                <td scope="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3 row">
                        <label for="tanggal" class="col-sm-2 col-form-label">Produk ID</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="produk_id" name="produk_id" value="<?php echo $produk_id ?>">
                        </div>
                    </div><div class="mb-3 row">
                        <label for="tanggal" class="col-sm-2 col-form-label">Quantity</label>
                        <div class="col-sm-10">
